...
(function (root) {
  ...
  var SOURCES = [
    ...
    { key: 'kenpoRei2026', label: '健康保険法施行令（令和8年8月1日施行版。令和8年政令第240号による改正後）', url: EGOV + '215IO0000000243/20260801_508CO0000000240', where: '42条 高額療養費算定基準額（70歳未満の区分ウ 85,800円＋（医療費−286,000円）×1% など）、41条の3・42条11項 年間の上限額（計算期間 8月1日〜翌年7月31日）' },
    { key: 'kenpoRei2027', label: '健康保険法施行令（令和9年8月1日施行版。同じ政令、未施行）', url: EGOV + '215IO0000000243/20270801_508CO0000000240', where: '42条1項 70歳未満の所得区分が13に（標準報酬月額127万円以上 342,000円＋1% 〜 16万円未満 61,500円・多数回34,500円）、5項 70歳以上の外来 28,000円など' },
    { key: 'mhlwKogaku', label: '厚生労働省「高額療養費制度を利用される皆さまへ」（更新 2026年7月31日）', url: MHLW + 'stf/seisakunitsuite/bunya/kenkou_iryou/iryouhoken/juuyou/kougakuiryou/index.html', where: '令和8年8月から月の上限額の見直しと年間上限の新設、令和9年8月から所得区分の細分化と年収200万円未満の多数回該当の引下げ。多数回該当の額は据え置き' },
  ...
  var TOOLS = {
    ...
    kuriage: { name: '年金の繰上げ・繰下げの計算', href: '../nenkin-kuriage/' },
    kogaku: { name: '高額療養費の計算', href: '../kogaku-ryoyohi/' },
  ...
  var ITEMS = [
    ...
    { id: '2026-04-zairo', date: '2026-04-01', cat: 'shaho', title: '在職老齢年金の基準額が月65万円に', what: '働きながら老齢厚生年金を受ける人の年金が減り始める基準（賃金と年金の合計）が月51万円から65万円に', who: '老齢厚生年金を受けながら会社で働く人',
      tools: [{ key: 'kuriage', note: '繰下げの待機中に働く人の増額（止まる分は増えない）を65万円で計算する' }], src: ['nenkinZairo'] },
    ...
    { id: '2026-08-kogaku', date: '2026-08-01', cat: 'shaho', title: '高額療養費の上限額の引上げと年間上限の新設', what: '8月診療分から月の自己負担の上限額が上がり（70歳未満・年収約370万〜770万円は80,100円＋1%から85,800円＋1%）、8月〜翌年7月の年間上限ができた。多数回該当の額は据え置き', who: '医療費の自己負担が高額になった人（健保・国保・後期高齢者医療）',
      tools: [{ key: 'kogaku', note: '診療月で表を選んで計算する（2026年7月までの表も残す）' }], src: ['kenpoRei2026', 'mhlwKogaku'] },
    ...
    { id: '2027-08-kogaku', date: '2027-08-01', cat: 'shaho', title: '高額療養費の所得区分が細かくなる', what: '8月診療分から、70歳未満の所得区分が5つから13に（年収約1,650万円以上は342,000円＋1%、年収約200万円以下の多数回該当は34,500円に）。年間上限の申請もこの月から', who: '医療費の自己負担が高額になった人',
      tools: [{ key: 'kogaku', note: '2027年8月からの表も入れてある（公布済みの政令の値）' }], src: ['kenpoRei2027', 'mhlwKogaku'] },
