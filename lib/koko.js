...
// 支給は 36 月（定時制・通信制は 48 月）まで。上乗せは東京都・大阪府・神奈川県の私立だけ（lib/koko-values.js の PREF）。
...
(function (root) {
  ...
  function calc(raw) {
    ...
    res.total = sum.selfFee + sum.selfShisetsu + res.nyugaku;   // 卒業までの自己負担（授業料＋入れた施設費など＋入学金）
