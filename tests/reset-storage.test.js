...
const PREFIXES = ["seido-keisan_"];
const LEGACY = [];
// 画面ごとに消す範囲を分けるページ（1 つのリポジトリに別々の道具があるとき）。書いていないページは PREFIXES
const PAGE_PREFIXES = {
  "dattai-ichiji/index.html": [
    "seido-keisan_dattai_draft"
  ],
  "ikukyu/index.html": [
    "seido-keisan_ikukyu_draft"
  ],
  "invoice/index.html": [
    "seido-keisan_invoice_draft"
  ],
  "iryohi/index.html": [
    "seido-keisan_iryohi_draft"
  ],
  "juminzei/index.html": [
    "seido-keisan_juminzei_draft"
  ],
  "kogaku-ryoyohi/index.html": [
    "seido-keisan_kogaku_draft"
  ],
  "koko-mushoka/index.html": [
    "seido-keisan_koko_draft"
  ],
  "nenkin-kuriage/index.html": [
    "seido-keisan_kuriage_draft"
  ],
  "nenmatsu/index.html": [
    "seido-keisan_nenmatsu_draft"
  ],
  "shienkin/index.html": [
    "seido-keisan_shienkin_draft"
  ],
