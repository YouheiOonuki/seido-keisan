...
年末調整・住民税・育休など、税と社会保険の制度の計算を国税庁・総務省・厚生労働省の資料や法令どおりに。出典と確認日つき。
...
| `favicon.svg` / `apple-touch-icon.png` / `og-image.png` | アイコン / ホーム画面用アイコン / SNS 共有用画像（1200×630）。`nenmatsu/og-image.png`・`juminzei/og-image.png`・`ikukyu/og-image.png` は各ページ用 |
