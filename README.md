...
- 上乗せ: 東京都（計 501,000円まで）・大阪府（就学支援推進校、授業料＋施設整備費等を 63 万円まで、超える分は学校）・神奈川県（22,800円、通信制 142,800円）・埼玉県（県認可の全日制。授業料は生活保護・家計急変だけ全額、基準①は施設費等 20 万円・入学金 22.3 万円、基準②は入学金 10 万円）・愛知県（授業料は国と同じ上限、入学納付金 20 万円・通信制 3.4 万円・専修 17 万円）・兵庫県（授業料は国と同じ、入学金支援 5 万円は生活保護・所得割 0 円の新入生）の私立だけ。ほかの道府県は計算せず、文部科学省の問合せ先へ案内
- 入学金・施設費は任意の入力で合計に足す（大阪府の施設整備費等、埼玉県の施設費等・入学金、愛知県・兵庫県の入学金の補助は引く）
...
| 毎年 9 月・4 月 | 文部科学省の概算要求（9 月）と新年度の支給限度額（4 月、施行令 2条）、東京都私学財団（助成の上限は 6〜7 月）・大阪府・神奈川県・埼玉県・愛知県・兵庫県（4〜6 月のリーフレット）の新年度の案内 | `lib/koko-values.js`（`MONTHLY`・`PER_UNIT`・`PREF`・`CHECKED`）、`tests/koko.test.js`、`koko-mushoka/` の年度の表記、`koko-mushoka/guide.html` の主な値と更新履歴 |
